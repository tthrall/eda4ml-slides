...
# TODO: Adjust the content to fit on one slide.
...
# TODO: put tibbles like this in one of the helper scripts
...
# TODO: This is a powerful diagram that shows 
# conceptual dependence.  Let's find a way to 
# make the graph, or a subgraph, more legible.
...
# TODO: Tony to adjust gap scenarios to align 
# proficiency levels required by work roles with 
# the ODNI DSci-CRG.  Requriements are currently 
# set too high.
...
# TODO: call functions using `pkgLLfn()` format
