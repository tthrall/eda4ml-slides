...
ar1_pacf <- astsa::pacf(ar1_sim, main = "PACF")
```
...
The PACF cutoff identifies the order: if PACF is significant at lags 1 through $p$ and near zero thereafter, consider AR(p).
...
$$X(t) = W(t) + 0.2 W(t-1), \quad \sigma_W^2 = 25$$
$$Y(t) = V(t) + 5 V(t-1), \quad \sigma_V^2 = 1$$
